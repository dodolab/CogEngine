...
/**
* Message that is used to send information ofxArbTween nodes
* and their behaviors
*/
class ofxAreMsg{
private:
...
public:
	...
	* @param data payload
	*/
	ofxAreMsg(BubblingType bubblingType, int action, int subAction, int behaviorId, ofxAreNode* sourceObj, void* data);
