...
public:
	...
	*/
	ofxAraTransform(float posX, float posY) : localPos(ofVec3f(posX, posY)), scale(1), rotationOrigin(ofVec3f(0.0f, 0.0f)), rotation(0){
		SetAbsAsLocal();
	}
	...
	*/
	void CalcAbsTransform(ofxAraTransform& parent){
		// calc absolute angle
