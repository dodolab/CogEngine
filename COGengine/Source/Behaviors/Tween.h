...
*/
class BeSlideTween : public Tween{
private:
	// tween direction
...
public:
	...
	* @param speed tweening speed
	*/
	BeSlideTween(TweenDirection direction, Node* tweenIn, Node* tweenOut, float speed) : Tween(tweenIn, tweenOut, speed), direction(direction){
