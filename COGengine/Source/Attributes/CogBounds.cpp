...
namespace Cog {
	...
	bool CogBounds::Collides(CogNode& first, CogNode& second) const {

		// image collision
		spt<ofImage> img1 = first.GetShape<spt<CogImage>>()->GetImage();
		spt<ofImage> img2 = second.GetShape<spt<CogImage>>()->GetImage();
