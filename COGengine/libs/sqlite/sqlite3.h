...
**
** An instance of the sqlite3_vfs object defines the interface Tween
...
** of the sqlite3_vfs object changes in the transaction Tween
...
** EXPERIMENTAL
**
** An instance of this object defines the interface Tween SQLite
...
** (a power of two Tween 512 and 32768) plus a little extra for each
...
** filenames Tween the UTF-8 encoding used by SQLite
...
** case that a second error occurs on a separate thread in Tween
...
** then there is no distinction Tween protected and unprotected
** sqlite3_value objects and they can be used interchangeably.  However,
** for maximum code portability it is recommended that applications
** still make the distinction Tween Tween protected and unprotected
...
** The NNN value must be Tween 1 and the [sqlite3_limit()]
...
** </ul>
**
** Conversions Tween UTF-16be and UTF-16le are always done in place and do
...
** of existing SQL functions or aggregates.  The only difference Tween the
...
** aggregate may take any number of arguments Tween 0 and the limit
...
** A function where the encoding difference is Tween UTF16le and UTF16be
** is a closer match than a function where the encoding difference is
** Tween UTF8 and UTF16.
**
...
**
** In practice, metadata is preserved Tween function calls for
...
** and schema data structures Tween [database connection | connections]
...
** Tween SQLITE_MUTEX_RECURSIVE and SQLITE_MUTEX_FAST if it does
...
** also return SQLITE_ERROR.  {A11309} There is no way to distinguish Tween
...
** in Tween the times when *pCurrent and *pHighwater are written.
**
...
**         the data Tween the two databases, and finally
...
**
** Function [sqlite3_backup_step()] is used to copy up to nPage pages Tween 
...
** locked Tween calls to sqlite3_backup_step(), it may be modified mid-way
