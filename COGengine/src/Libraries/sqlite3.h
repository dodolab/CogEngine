...
**
** An instance of the sqlite3_vfs object defines the interface ofxArbTween
...
** of the sqlite3_vfs object changes in the transaction ofxArbTween
...
** EXPERIMENTAL
**
** An instance of this object defines the interface ofxArbTween SQLite
...
** (a power of two ofxArbTween 512 and 32768) plus a little extra for each
...
** filenames ofxArbTween the UTF-8 encoding used by SQLite
...
** case that a second error occurs on a separate thread in ofxArbTween
...
** then there is no distinction ofxArbTween protected and unprotected
** sqlite3_value objects and they can be used interchangeably.  However,
** for maximum code portability it is recommended that applications
** still make the distinction ofxArbTween ofxArbTween protected and unprotected
...
** The NNN value must be ofxArbTween 1 and the [sqlite3_limit()]
...
** </ul>
**
** Conversions ofxArbTween UTF-16be and UTF-16le are always done in place and do
...
** of existing SQL functions or aggregates.  The only difference ofxArbTween the
...
** aggregate may take any number of arguments ofxArbTween 0 and the limit
...
** A function where the encoding difference is ofxArbTween UTF16le and UTF16be
** is a closer match than a function where the encoding difference is
** ofxArbTween UTF8 and UTF16.
**
...
**
** In practice, metadata is preserved ofxArbTween function calls for
...
** and schema data structures ofxArbTween [database connection | connections]
...
** ofxArbTween SQLITE_MUTEX_RECURSIVE and SQLITE_MUTEX_FAST if it does
...
** also return SQLITE_ERROR.  {A11309} There is no way to distinguish ofxArbTween
...
** in ofxArbTween the times when *pCurrent and *pHighwater are written.
**
...
**         the data ofxArbTween the two databases, and finally
...
**
** Function [sqlite3_backup_step()] is used to copy up to nPage pages ofxArbTween 
...
** locked ofxArbTween calls to sqlite3_backup_step(), it may be modified mid-way
